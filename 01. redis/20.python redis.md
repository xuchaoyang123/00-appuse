...
def redis_cluster_if(x):
    ...
    if x == 1:
        def redis_cluster():
            r =[
                        {"host":"192.168.0.31","port":7629},
                        {"host":"192.168.0.31","port":7639},
                        {"host":"192.168.0.32","port":7629},
                        {"host":"192.168.0.32","port":7639},
                        {"host":"192.168.0.33","port":7629},
                        {"host":"192.168.0.33","port":7639},
                ]
